  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center">
                <Calendar className="text-[#003A79] h-6 w-6" />
              </div>
              <div>
                <h1 className="text-xl font-bold">University of Toronto Scarborough</h1>
                <p className="text-blue-200 text-sm">SDG Data Challenge 2026</p>
              </div>
            </div>
      ...
      <section className="bg-gradient-to-br from-[#003A79] to-[#0060AC] text-white py-20 min-h-[80vh] flex items-center">
        <div className="container mx-auto px-4 text-center">
          <div className="flex justify-center mb-6">
            <Clock className="h-24 w-24 text-green-400 animate-pulse" />
          </div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6">2026 Challenge</h1>
          <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
            More information about the 2026 UTSC SDG Data Challenge coming soon.
          </p>
      ...
      <footer className="bg-[#003A79] text-white py-12">
        <div className="container mx-auto px-4 text-center">
          <h3 className="text-2xl font-bold mb-4">UTSC SDG Data Challenge 2026</h3>
          <p className="text-blue-200 mb-6">More information coming soon.</p>
          <Separator className="my-8 bg-blue-800" />
          <p className="text-blue-200">&copy; 2026 University of Toronto Scarborough. All rights reserved.</p>
        </div>
      </footer>
    </div>
  )
